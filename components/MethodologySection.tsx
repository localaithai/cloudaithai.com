...
const principles = [
  {
    ...
    subtitle: "เราเชื่อว่าไม่มี solution สำเร็จรูปที่เหมาะกับทุกธุรกิจ มีแต่ระบบที่สร้างขึ้นให้พอดีกับความต้องการเฉพาะ ทุกชิ้นงานที่ส่งมอบจึงไม่เหมือนกันแม้แต่สองชิ้น",
    quote: "ระบบที่ดีที่สุด คือระบบที่พอดีกับวิธีทำงานของคุณ — ไม่ใช่ระบบที่ฟีเจอร์เยอะที่สุด",
  },
  {
    icon: GitBranch,
    color: "#ff6d5a",
