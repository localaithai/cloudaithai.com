      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-md bg-gradient-to-br from-[#0071e3] to-[#5856d6] flex items-center justify-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-[13px] text-[#6e6e73]">
            ...
            <a href="https://localaithai.com" target="_blank" className="hover:text-[#0071e3] transition-colors">LocalAI Thailand</a>
          </div>
