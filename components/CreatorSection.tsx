...
import {
  ...
  ThumbsUp, Bot, Wand2, LineChart, MousePointerClick, AlertTriangle
} from "lucide-react";
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <div className="rounded-2xl border border-[#ff9500]/20 bg-[#ff9500]/[0.03] p-6 sm:p-8">
              ...
              <div className="space-y-3">
                {[
                  { title: "Content อาจไม่ถูกต้อง 100%", desc: "AI อาจสร้าง content ที่มีข้อมูลผิดพลาด หรือ tone ไม่ตรง brand — ควรมีคนตรวจสอบก่อนโพสต์ทุกครั้ง" },
                  { title: "ข้อมูล brand ถูกส่งไป Cloud", desc: "Brand voice, กลยุทธ์ content, ข้อมูล engagement ถูกส่งผ่าน API ไปยัง server ต่างประเทศ — คู่แข่งอาจใช้ provider เดียวกัน" },
                  { title: "ค่า API ขึ้นอยู่กับปริมาณ content", desc: "ยิ่งสร้าง content เยอะ ค่าใช้จ่าย API ยิ่งสูง — ช่วง campaign หนักอาจเกินงบที่ตั้งไว้" },
                  { title: "ลิขสิทธิ์ AI-generated content", desc: "กฎหมายลิขสิทธิ์สำหรับ content ที่ AI สร้างยังไม่ชัดเจนในไทย — ควรระวังเรื่องการใช้ในเชิงพาณิชย์" },
                ].map((risk) => (
